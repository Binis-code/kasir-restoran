...
import { db, ensureSeeded, type OrderRow, type OrderStatus, type OrderType, type PayMethod } from "../lib/db";
import { loadOrders, loadProducts, saveOrder } from "../lib/repo";

export type { OrderType, PayMethod, OrderStatus };
  ...
  const recordOrder = useCallback(
    (status: OrderStatus, recordedTotals: OrderTotals, method?: PayMethod) => {
      const row: OrderRow = {
        ...
        method,
        orderType,
        tableNumber: orderType === "meja" ? 4 : undefined,
